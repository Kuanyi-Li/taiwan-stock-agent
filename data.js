...
// 3. 美股/台股 自動判斷：全字母代碼 = 美股，數字代碼 = 台股
// 4. 休市時不更新（由 APP 控制，data.js 本身不判斷）
...
const DATA = {
  ...
  // ── 主要更新入口 ──────────────────────────────────────
  // 由 APP.refreshPrices() 統一呼叫，並已在外部判斷休市
